...
| `debezium.sink.iceberg.upsert-keep-latest`                   | `false`                                                       | Retain latest event regardless of `upsert-dedup-column` and `upsert-op-field`                                                                                                                                                                                                                                     |
...
Alternatively, it's possible to retain the latest record by setting `debezium.sink.iceberg.upsert-keep-latest` to `true`.
