...
| `debezium.sink.iceberg.force-all-fields-optional`            | `false`                                                       | When set to `true`, all fields (including primary key fields) will be created as optional in the Iceberg schema. This setting takes precedence over `preserve-required-property`.                                                                                                                                 |
