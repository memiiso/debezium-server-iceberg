...
|--------------------------------------------------------------|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `debezium.sink.type`                                         | `iceberg`                                                     | Debezium server configuration, must be set to 'iceberg' to activate the Iceberg consumer.                                                                                                                                                                                                                            |
...
| `debezium.sink.iceberg.excluded-columns`                     | ``                                                            | Comma-separated list of column names to exclude from replication and target table schema.                                                                                                                                                                                                                        |
...
| `debezium.sink.iceberg.upsert-use-dv`                        | `(auto)`                                                      | Controls whether Deletion Vectors (DVs) are used in upsert mode. Defaults to `true` when table format version is > 2 (`formatVersion > 2`), or `false` otherwise.                                                                                                                |
...
| `debezium.sink.iceberg.upsert-op-field`                      | `__op`                                                        | Field name for operation type in upsert mode. _don't change!_                                                                                                                                                                                                                                                      |
...
| `debezium.sink.iceberg.format-version`                       | `3`                                                           | Iceberg table format version used when creating new tables. `2` uses equality-delete files; `3` enables [Deletion Vectors](https://iceberg.apache.org/docs/latest/deletion-vectors/) for more efficient deletes in upsert mode. Set to `2` to maintain backward compatibility with older Iceberg readers.         |
...
| `debezium.sink.iceberg.openlineage-enabled`                  | `false`                                                       | Enables OpenLineage metadata logging for Iceberg commits.                                                                                                                                                                                                                                                         |
