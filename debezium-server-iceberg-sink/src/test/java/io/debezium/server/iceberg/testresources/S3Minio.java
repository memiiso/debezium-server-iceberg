...
public class S3Minio implements QuarkusTestResourceLifecycleManager {
  ...
  public static final String ICEBERG_CATALOG_FILEIO = "org.apache.iceberg.io.ResolvingFileIO";
  public static final String S3_WAREHOUSE_BUCKET_NAME = "test-bucket";
  public static final String S3_WAREHOUSE_BUCKET_DIR = "s3://" + S3_WAREHOUSE_BUCKET_NAME + "/iceberg_warehouse";
  ...
  public Map<String, String> start() {
    ...
    try {
      ...
      client.makeBucket(MakeBucketArgs.builder()
          .region(S3Minio.S3_REGION)
          .bucket(S3_WAREHOUSE_BUCKET_NAME)
          .build());
    } catch (Exception e) {
      e.printStackTrace();
    }
    ...
    config.put("debezium.sink.iceberg.client.region", S3Minio.S3_REGION);
    config.put("debezium.sink.iceberg.io-impl", S3Minio.ICEBERG_CATALOG_FILEIO);
    config.put("debezium.sink.iceberg.warehouse", S3_WAREHOUSE_BUCKET_DIR);
    // FOR HADOOP CATALOG
